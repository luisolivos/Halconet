...
{
    public partial class frmLineaObjetivo : Form
    {
        Clases.Logs log;
        public frmLineaObjetivo(int rolUsuario, int codigoVendedor, string nombreUsuario, string sucursal)
        {
        ...
        private void btnPresentar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(cbLinea.SelectedValue) == 201)
                {
                    commandLienasMoradas.Parameters.AddWithValue("@TipoConsulta", TipoConsulta.LineasObjetivo);
                } 
                if (Convert.ToInt32(cbLinea.SelectedValue) == 159)
                {
                    commandLienasMoradas.Parameters.AddWithValue("@TipoConsulta", 12);
                }
                if (Convert.ToInt32(cbLinea.SelectedValue) == 241)
                {
                    commandLienasMoradas.Parameters.AddWithValue("@TipoConsulta", 25);
                }
                ...
                //if (Convert.ToInt32(cbLinea.SelectedValue) == 201 || Convert.ToInt32(cbLinea.SelectedValue) == 241)
                //{
                ...
                //}
                //if (Convert.ToInt32(cbLinea.SelectedValue) == 242)
                //{
                //    gridTotales.Columns[0].DefaultCellStyle.Format = "N0";
                //    gridTotales.Columns[1].DefaultCellStyle.Format = "N0";
                //    gridTotales.Columns[2].DefaultCellStyle.Format = "P2";
                //    gridTotales.Columns[3].DefaultCellStyle.Format = "N0";
                //    gridTotales.Columns[4].DefaultCellStyle.Format = "N0";
                //    gridTotales.Columns[5].DefaultCellStyle.Format = "P2";
                //}
        ...
        private void DarFormatoGrid()
        {
            ...
            //if (Convert.ToInt32(cbLinea.SelectedValue) == 242 )
            //{
            //    gridLineas.Columns[(int)ColumnasGrid.Objetivo].DefaultCellStyle.Format = "N0";
            //    gridLineas.Columns[(int)ColumnasGrid.Venta].DefaultCellStyle.Format = "N0";
            //    gridLineas.Columns[(int)ColumnasGrid.VentavsCuota].DefaultCellStyle.Format = "P2";
            //    gridLineas.Columns[(int)ColumnasGrid.Porvender].DefaultCellStyle.Format = "N0";
            //    gridLineas.Columns[(int)ColumnasGrid.TendenciaFinMesM].DefaultCellStyle.Format = "N0";
            //    gridLineas.Columns[(int)ColumnasGrid.TendenciaFinMesP].DefaultCellStyle.Format = "P2";
            //}
        ...
        private void CargarLinea()
        {
            try
            {
                ...
                commandVendedor.Parameters.AddWithValue("@Fecha", dtpFecha.Value);
                commandVendedor.Parameters.AddWithValue("@Bono", Fecha.Month);
                commandVendedor.Parameters.AddWithValue("@From", "PJ");
