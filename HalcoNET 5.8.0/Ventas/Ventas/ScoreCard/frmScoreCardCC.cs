...
namespace Ventas
{
    public partial class ScoreCardCC : Form
    {
        Clases.Logs log;
        #region PARÁMETROS
        ...
        public ScoreCardCC(int rolUsuario, int codigoVendedor, string nombreUsuario, string sucursal)
        {
            InitializeComponent();
        ...
        private void btnPresentar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Vendedores = CrearCadena(clbTitular);
                ...
                commandVendedores.Parameters.AddWithValue("@TipoConsulta", 6);
                commandVendedores.Parameters.AddWithValue("@Cliente", Cliente);
                commandVendedores.Parameters.AddWithValue("@Sucursales", string.Empty);
                commandVendedores.Parameters.AddWithValue("@Vendedores", Vendedores);
                ...
                gridClientes.DataSource = tblClientes;
                ...
                if (RolUsuario != (int)ClasesSGUV.Propiedades.RolesHalcoNET.Ventas)
                {
                    var query = (from item in tblVendedores.AsEnumerable()
                                 select item.Field<string>("Titular CC")).Distinct();
                    int id = 1016;
                    foreach (var item in query.ToList())
                    {
                        DataRow r = tblVendedores.NewRow();
                        r["ClaveCC"] = id.ToString();
                        r["Titular CC"] = item + " Total";
                        r["Venta del día"] = (from acum in tblVendedores.AsEnumerable()
                                              where acum.Field<string>("Titular CC") == item
                    ...
                    tblVendedores = (from tv in tblVendedores.AsEnumerable()
                                     orderby tv.Field<string>("Titular CC")
                ...
                DataRelation relation = new DataRelation("VendedoresCliente", data.Tables["TablaVendedores"].Columns["ClaveCC"], data.Tables["TablaClientes"].Columns["ClaveCC"]);
                ...
                {
                    if (Convert.ToString(item.Cells[(int)ColumnasGrid.TitularCC].Value).Contains("Total"))
                    {
        ...
        {
            if (clbTitular.SelectedIndex == 0)
            {
                if (clbTitular.CheckedIndices.Contains(0))
                {
                    for (int item = 1; item < clbTitular.Items.Count; item++)
                    {
                        clbTitular.SetItemChecked(item, false);
                    }
                }
                else
                {
                    for (int item = 1; item < clbTitular.Items.Count; item++)
                    {
                        clbTitular.SetItemChecked(item, true);
                    }
                }
            }
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            //        }
            //        MessageBox.Show("Presupuesto actualizado correctamente", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //        Guardar = false;
            //        this.Text = "HalcoNET - Score card";
        ...
        private void gridVendedores_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            try
            {
                foreach (DataGridViewRow row in gridVendedores.Rows)
                {
                    ...
                    //pinta totales
                    if (Convert.ToString(row.Cells[(int)ColumnasGrid.TitularCC].Value).Contains("Total"))
                    {
        ...
        private void gridClientes_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            try
            {
                ...
                {
                    //pinta acumulado vs cuota
                    if (Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Value) * 100 >= 100)
                    {
                    ...
                    else if (Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Value) * 100 < 100
                        && Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Value) * 100 >= 85)
                    {
                        row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Style.BackColor = Color.FromArgb(255, 255, 0);//yellow
                        row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Style.ForeColor = Color.Black;
                    }
                    else if (Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Value) * 100 < 85
                        && Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Value) * 100 > 0)
                    {
                        row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Style.BackColor = Color.FromArgb(255, 102, 0);//orange
                        row.Cells[(int)ColumnasGridDetalle.AcumuladoVSCuotaP].Style.ForeColor = Color.Black;
                    }
                    ...
                    //pinta pronostico fin de mes
                    if (Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Value) * 100 >= 100)
                    {
                    ...
                    else if (Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Value) * 100 < 100
                        && Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Value) * 100 >= 85)
                    {
                        row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Style.BackColor = Color.FromArgb(255, 255, 0);//yellow
                        row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Style.ForeColor = Color.Black;
                    }
                    else if (Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Value) * 100 < 85
                        && Convert.ToDecimal(row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Value) * 100 > 0)
                    {
                        row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Style.BackColor = Color.FromArgb(255, 102, 0);//orange
                        row.Cells[(int)ColumnasGridDetalle.PronosticoFinMEsP].Style.ForeColor = Color.Black;
                    }
        ...
        private void CargarVendedores()
        {
            ...
            SqlCommand commandClientes = new SqlCommand("PJ_ScoreCardVentas", new SqlConnection(ClasesSGUV.Propiedades.conectionSGUV));
            commandClientes.CommandType = CommandType.StoredProcedure;
            commandClientes.Parameters.AddWithValue("@TipoConsulta", 1);
            commandClientes.Parameters.AddWithValue("@Cliente", string.Empty);
            commandClientes.Parameters.AddWithValue("@Sucursales", string.Empty);
            commandClientes.Parameters.AddWithValue("@Vendedores", string.Empty);
            commandClientes.Parameters.AddWithValue("@Presupuesto", RolUsuario);
            ...
            clbTitular.DataSource = table;
            clbTitular.DisplayMember = "Nombre";
            clbTitular.ValueMember = "Codigo";
        ...
        public void DarFormatoGridVendedores()
        {
            ...
            gridVendedores.Columns[(int)ColumnasGrid.ClaveCC].Width = 100;
            gridVendedores.Columns[(int)ColumnasGrid.TitularCC].Width = 200;
        ...
        public void DarFormatoGridClientes()
        {
           ...
           // gridClientes.ColumnHeadersDefaultCellStyle.BackColor = gridVendedores.ColumnHeadersDefaultCellStyle.BackColor;
            ...
            gridClientes.Columns[(int)ColumnasGridDetalle.ClaveCC].Width = 100;
            gridClientes.Columns[(int)ColumnasGridDetalle.Cliente].Width = 80;
            gridClientes.Columns[(int)ColumnasGridDetalle.NombreCliente].Width = 200;
            gridClientes.Columns[(int)ColumnasGridDetalle.Vendedor].Width = 100;
            gridClientes.Columns[(int)ColumnasGridDetalle.Sucursal].Width = 100;
        ...
        private DataTable CrearTablaClientes()
        {
            ...
            t.Columns.Add("ClaveCC", typeof(string));
            t.Columns.Add("Cliente", typeof(string));
            t.Columns.Add("Nombre del cliente", typeof(string));
            ...
            t.Columns.Add("Acumulado VS Cuota(%)", typeof(decimal), "IIF([Presupuesto Mensual] <> 0, Acumulado / [Presupuesto Mensual], IIF(Acumulado <= 0,0,1))");
        ...
        private DataTable CrearTablaVendedores()
        {
            ...
            t.Columns.Add("ClaveCC", typeof(string));
            t.Columns.Add("Titular CC", typeof(string));
            t.Columns.Add("Venta del día", typeof(decimal));
            t.Columns.Add("Acumulado", typeof(decimal));
            t.Columns.Add("Presupuesto Mensual", typeof(decimal));
            t.Columns.Add("Acumulado VS Cuota($)", typeof(decimal), "ISNULL(Acumulado - [Presupuesto Mensual],0)");
