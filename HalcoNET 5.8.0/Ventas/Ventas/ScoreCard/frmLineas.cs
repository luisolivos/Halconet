...
namespace Ventas
{
    public partial class frmLineas : Form
    {
        ...
        public frmLineas(int rolUsuario, int codigoVendedor, string nombreUsuario, string sucursal)
        {
            InitializeComponent();
        ...
        private void frmLineas_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                log.Fin();
