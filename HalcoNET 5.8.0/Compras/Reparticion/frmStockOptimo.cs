...
{
    public partial class frmTraspasosImpo : Form
    {
        public enum Columas
        {
            Linea,
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(ClasesSGUV.Propiedades.conectionSGUV))
                {
                    using (SqlCommand command = new SqlCommand("sp_Importacion", connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@Tipo", rbImportacion.Checked ? "IMP" : (rbNacional.Checked ? "NAC" : string.Empty));
        ...
        private void rb_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rbNacional.Checked) tip = "NAC";
                if (rbImportacion.Checked) tip = "IMP";
                ...
                using (SqlConnection connection = new SqlConnection(ClasesSGUV.Propiedades.conectionSGUV))
                {
                    using (SqlCommand command = new SqlCommand("sp_Importacion", connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@Tipo", tip);
